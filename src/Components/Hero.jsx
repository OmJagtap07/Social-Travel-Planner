...
const Hero = ({ onSearch }) => {
  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden bg-black">
      ...
      {/* 1. BACKGROUND IMAGES (Fades smooth) */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
        ...
        {/* SEARCH BAR */}
        <div className="mt-8 w-full max-w-4xl bg-white rounded-full p-2 flex items-center shadow-2xl">
          <div className="pl-6 flex items-center flex-1 border-r border-gray-200">
            <svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input 
              type="text" 
              placeholder="Where do you want to go? (Try 'Japan')" 
          ...
          <div className="flex space-x-2 p-1">
            <button 
              ...
              className="bg-gray-100 hover:bg-gray-200 text-gray-900 px-6 py-3 rounded-full font-bold text-sm transition-colors"
            >
              Search
            </button>
            <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-full font-bold text-sm shadow-lg flex items-center gap-2">
